...
deliveries=spark.read.csv('hdfs://localhost:9000/test/deliveries.csv',sep=',',header=True,inferSchema=True)
...
subprocess.run(['hdfs','dfs','-mv','/test/deliveries.csv','/Archives'])
